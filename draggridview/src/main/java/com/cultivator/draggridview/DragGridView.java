...
//            selectView.findViewById(R.id.delete_img).setVisibility(INVISIBLE);//删除按钮
            selectView.findViewById(getItemContainerRid()).setVisibility(VISIBLE);
            selectView.findViewById(getItemContainerRid()).setBackgroundColor(Color.WHITE);
        }
    }
    ...
    public void startDrag(int position) {
        ...
        if (selectView != null) {
             ...
             * 移动的图像背景要有区别,并显示删除按钮
             */
            selectView.findViewById(getItemContainerRid()).setBackgroundColor(Color.parseColor("#f8f8f8"));
//            selectView.findViewById(R.id.delete_img).setVisibility(VISIBLE);
            ...
            selectView.findViewById(getItemContainerRid()).setVisibility(INVISIBLE);
    ...
    private void swapItems(int x, int y) {
        ...
        if (endPosition != INVALID_POSITION && endPosition != currentPosition) {
            ...
            selectView.findViewById(getItemContainerRid()).setVisibility(INVISIBLE);
            selectView.findViewById(getItemContainerRid()).setBackgroundColor(Color.parseColor("#f0f0f0"));
//            selectView.findViewById(R.id.delete_img).setVisibility(VISIBLE);
    ...
    private int getItemContainerRid(){
        return getResourceId("id","item_container");
    }

    private int getResourceId(String dir,String idName){
        Resources resources = getResources();
        String packageName = getContext().getPackageName();
        return resources.getIdentifier(idName,dir,packageName);
    }
