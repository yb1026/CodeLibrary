package com.cultivator.codelibrary.widget.password;
...
/**
 * <com.cultivator.views.password.PasswordInputView
...
public class PasswordInputView extends EditText {
    ...
    public static interface InputListener {
        void firstInput(String pwd);

        void comfirm(String pwd);

        void comfirmDifferent();
    }
    ...
    public void setInputListener(final InputListener inputListener) {
        this.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (getText().length() == passwordLength) {


                    if (tempInput==null||tempInput.trim().length()==0) {
                        tempInput = getText().toString();
                        inputListener.firstInput(tempInput);
                    } else if (tempInput.equals(getText().toString())) {
                        inputListener.comfirm(tempInput);
                    } else {
                        inputListener.comfirmDifferent();
                    }
                }
            }
        });
    ...
    private int passwordColor = 0x6666666;
